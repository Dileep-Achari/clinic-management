...
function preparePayload_bkp(_type, _body) {
    try {
        return new Promise((resolve, reject) => {
            let _params = {};
            let _payload = {
                                                            ...
                                                            _.each(_val2, (_val3, _key3) => {
                                                                if (_val3.constructor.name === 'Object') {
                                                                    if (!_val3._id || _val3._id === '') {
                                                                        ...
                                                                        if (_dLen) {
                                                                            let _apndList = [];
                                                                            if (_dLen.constructor.name === "Array") {
                                                                                _apndList = _dLen
                                                                            } else if (_dLen.constructor.name === "Object") {
                                                                                _apndList.push(_dLen);
                                                                            }
                                                                            _apndList.push(_val3);
                                                                            _payload.query.$push[`${_key}.$.${_key2}`] = _apndList;
                                                                ...
                                                                if (!_ev2._id) {
                                                                    ...
                                                                    _.each(_ev2, (_ev3, _ek3) => {
                                                                        if (_ek3 === '_id') {
                                                                            ...
                                                                            _cloneBw1.updateOne.filter[`${_key}.${_ek1}._id`] = _ev3;
                                                                            let _obj = {};
                                                                            _obj[`${_ek1}${_ek2}._id`] = mongoose.Types.ObjectId(`${_ev2._id}`)
                                                                            _cloneBw1.updateOne.arrayFilters.push(_obj)

                                                                        }
                                                                        else {
                                                                            if (_ev3.constructor.name === 'Array' || _ev3.constructor.name === 'Object') {
                                                                                //_.each(_ev3, (_ev4, _ek4) => {                        // it create duplicate of arreys and objects
                                                                                if (_ev3.constructor.name === 'Array') {
                                                                                    _.each(_ev3, (_ev4, _ek4) => {
                                                                                        if (!_ev4._id && _ev4._id !== '') {
                                                                                            let _cloneBwV1 = JSON.parse(JSON.stringify(_bwObj));
                                                                                            ...
                                                                                            _.each(_ev4, (_ev5, _ek5) => {
                                                                                                if (_ek5 === '_id') {
                                                                                                    _cloneBw1.updateOne.filter[`${_key}.${_ek1}.${_ek3}._id`] = _ev5;
                                                                                                    let _obj = {};
                                                                                                    _obj[`${_ek3}${_ek4}._id`] = mongoose.Types.ObjectId(`${_ev4._id}`)
                                                                                                    _cloneBw1.updateOne.arrayFilters.push(_obj)
                                                                                                }
                                                                                                else {
                                                                                                    _cloneBw1.updateOne.update.$set[`${_key}.$.${_ek1}.$[${_ek1}${_ek2}].${_ek3}.$[${_ek3}${_ek4}].${_ek5}`] = _ev5;
                                                                                                }
                                                                                            });
                                                                                        }
                                                                                    })
                                                                                    ...
                                                                                    //     });
                                                                                    // }
                                                                                } else if (_ev3.constructor.name === 'Object') {
                                                                                    if (_ev3._id) {
                                                                                        let _cloneBwV2 = JSON.parse(JSON.stringify(_bwObj));
                                                                                        _cloneBwV2.updateOne.filter = JSON.parse(JSON.stringify(_cloneBw1.updateOne.filter));
                                                                                        _cloneBwV2.updateOne.arrayFilters = _cloneBw1.updateOne.arrayFilters;
                                                                                        _.each(_ev3, (_ev6, _ek6) => {
                                                                                            if (_ek6 == "_id") {
                                                                                                _cloneBwV2.updateOne.filter[`${_key}.${_ek1}.${_ek3}._id`] = _ev6
                                                                                            } else {
                                                                                                _cloneBwV2.updateOne.update.$set[`${_key}.$.${_ek1}.$[${_ek1}${_ek2}].${_ek3}.${_ek6}`] = _ev6;
                                                                                            }
                                                                                        })
                                                                                        if (Object.keys(_cloneBwV2.updateOne.update.$set).length > 0) {
                                                                                            _bwData.push(_cloneBwV2);
                                                                                        }
                                                                                    }
                                                                                    else {
                                                                                        _cloneBw1.updateOne.update.$set[`${_key}.$.${_ek1}.$[${_ek1}${_ek2}].${_ek3}`] = _ev3;
                                                                                    }
                                                                                }
                                                                                else {
                                                                                    _cloneBw1.updateOne.update.$set[`${_key}.$.${_ek1}.$[].${_ek3}.${_ek4}`] = _ev4;
...
function preparePayload_bkp1(_type, _body) {
    try {
        return new Promise((resolve, reject) => {
            let _params = {};
            let _payload = {
                                                                ...
                                                                if (!_ev2._id) {
                                                                    ...
                                                                    _.each(_ev2, (_ev3, _ek3) => {
                                                                        if (_ek3 === '_id') {
                                                                            ...
                                                                            _obj[`${_ek1}${_ek2}._id`] = mongoose.Types.ObjectId(`${_ev2._id}`)
                                                                            _cloneBw1.updateOne.arrayFilters.push(_obj)
                                                                            _cloneFirstObject = _.cloneDeep(_cloneBw1)
                                                                        }
                                                                        else {
                                                                            if (_ev3.constructor.name === 'Array' || _ev3.constructor.name === 'Object') {
                                                                                //_.each(_ev3, (_ev4, _ek4) => {                        // it create duplicate of arreys and objects
                                                                                if (_ev3.constructor.name === 'Array') {
                                                                                    ...
                                                                                    if (_ev3._id) {
                                                                                        let _cloneBwV2 = JSON.parse(JSON.stringify(_bwObj));
                                                                                        _cloneBwV2.updateOne.filter = JSON.parse(JSON.stringify(_cloneFirstObject.updateOne.filter));
                                                                                        _cloneBwV2.updateOne.arrayFilters = _cloneFirstObject.updateOne.arrayFilters;
                                                                                        _.each(_ev3, (_ev6, _ek6) => {
                                                                                            if (_ek6 == "_id") {
                                                                                                _cloneBwV2.updateOne.filter[`${_key}.${_ek1}.${_ek3}._id`] = _ev6
                                                                                            } else {
                                                        ...
                                                        if (_fId && _fId.length === 0) {
                                                            ...
                                                            _.each(_ev1, (_ev2, _ek2) => {
                                                                ...
                                                                if (!_ev2._id) {
                                                                    ...
                                                                    let _objKeys = Object.keys(_ev2).reduce((_ov, _ok) => {
                                                                        if (_ok === '_id') {
                                                                            _ov = { _id: _ev2[_ok], ..._ov };
                                                                        }
                                                                        else{
                                                                            _ov[_ok] = _ev2[_ok];
                                                                        }
                                                                        ...
                                                                        if (_ek3 === '_id') {
                                                                            ...
                                                                            if (_ev3.constructor.name === 'Array' || _ev3.constructor.name === 'Object') {
                                                                                ...
                                                                                if (_ev3.constructor.name === 'Array') {
                                                                                    ...
                                                                                    if (_ev3._id) {
                                                                                        let _cloneBwV2 = JSON.parse(JSON.stringify(_bwObj));
                                                                                        console.log("_cloneBwV2",_cloneBwV2,_bwObj,_cloneFirstObject)
                                                                                        _cloneBwV2.updateOne.filter = JSON.parse(JSON.stringify(_cloneFirstObject.updateOne.filter));
                                                                                        _cloneBwV2.updateOne.arrayFilters = _cloneFirstObject.updateOne.arrayFilters;
                                                                                        _.each(_ev3, (_ev6, _ek6) => {
                                                                                            if (_ek6 == "_id") {
...
async function validateMethod(_method, _payload) {
    ...
    if (!_method) {
        ...
        if (!_mdl || Object.keys(_mdl).length == 0) {
            ...
            //console.log("_schemaData",_mdl, _method)
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            let _hParams = {
                tranId: _mParams._id,
                method: _method,
                sessionId: req.body.params.sessionId ? req.body.params.sessionId : "",
            ...
            if(_hMethod == "ophthamology"){
                _hMethod = "ophthamology_ecg"
            }
...
async function getSequenceNextValue(params, _cntrs, req) {
    try {
        let _filter = {
            by: { locId: params.locId, seqName: params.seqName, orgId: params.orgId },
            query: { $inc: { seqValue: 1 } },
            mode: { new: true }
        }
        if (params.orgId && params.orgId.length > 0) {
            delete _filter.by.locId
        } else {
            delete _filter.by.orgId
        }
        ...
        //newly added
        else if (_seqResp.data.format && _seqResp.data.format != 'YYMM') {
            let datePart = moment().format(_seqResp.data.format);
            _frmDigit = datePart + _frmDigit
           // _frmDigit = moment().format('YYYY') + moment().format('MM') + moment().format('DD') + _frmDigit;
        }
        //newly added
