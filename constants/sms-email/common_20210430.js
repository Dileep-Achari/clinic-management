...
function smsWithTemplate(orgId, locId, mobileNo, template, req_type_id) {
    return new Promise(async (resolve, reject) => {
        if (orgId && locId && mobileNo && template) {
            const resp = await smsHelper(orgId, locId, mobileNo, template,req_type_id);
