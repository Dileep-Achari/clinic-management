const pg = require('pg');
const connectionString = require("../../config/connection-string")("pgDbDOC");
...
module.exports = (_schema, _payLoad, _cParams) => {
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            if (sendRespArr && sendRespArr.length > 0 && sendRespArr[0].error_cd && sendRespArr[0].error_msg) {
