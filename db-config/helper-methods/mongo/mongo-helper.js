    ...
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            if (!_payload.success || !_payload.data.model || !_action) {
                ...
                if (_action === 'find' || _action === 'findCount' || _action === 'aggregation') {
                    _payload.data.filter = _params.filter;
                    _payload.data.selectors = _params.selectors;
                    _payload.data.limit = _params.limit;
                    _payload.data.skipData = _params.skipData;
                    _payload.data.populate = _params.populate;
                }
                    ...
                    _payload.data.filter = _params.filter;
                    _payload.data.update = _params.update;
                }
                let _model = null;
                if (!_key) {
