...
const _patientSchema = new mongoose.Schema([
    {
        ...
        abhaJson: [{ type: mongoose.Schema.Types.ObjectId, ref: 'AbhaJson' }],
        contact: _contactSchema,
...
const _glassPrescriptionSchema = new mongoose.Schema({
    ...
    sphere: {
        ...
        right: {
            type: String, required: function () {
                return this.glassType == "PRESCRIPTIONGLASSES"
            },
        },
        left: {
            type: String, required: function () {
    ...
    power: {
        ...
        right: {
            type: String, required: function () {
                return this.glassType == "SINGLENEARVISIONGLASSES" || this.glassType == "PLANOBIFOCAL"
            },
        },
        left: {
            type: String, required: function () {
    ...
    status: {
        type: String,
        enum: ['Pending for CHC Approval', 'Pending for State Approval', 'Reject at CHC Level', 'Reject at State Level', 'Approved', 'Sent to Manufacturer', 'Received from Manufacturer', 'Ready To Dispatch', 'Dispatched to Patient', 'Rejected at PHC User'],
...
const _abhaJson = new mongoose.Schema([{ any: mongoose.Schema.Types.Mixed }], { strict: false });
...
const _prescriptions = new mongoose.Schema([
    {
        "_id": {
            type: mongoose.Schema.Types.ObjectId,
            required: true,
...
module.exports = [
    ...
    { "coll": 'AbhaJson', "schema": _abhaJson, "db": "ophthamology_ecg" },
    ...
    { "coll": 'Prescriptions', "schema": _prescriptions, "db": "ophthamology_ecg" },
