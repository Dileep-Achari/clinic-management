...
const _glassPrescriptionSchema = new mongoose.Schema({
    ...
    status: {
        type: String,
        enum: ['Pending for CHC Approval', 'Pending for State Approval', 'Reject at CHC Level', 'Reject at State Level', 'Approved', 'Sent to Manufacturer', 'Received from Manufacturer', 'Ready To Dispatch', 'Dispached to Patient', 'Rejected'],
