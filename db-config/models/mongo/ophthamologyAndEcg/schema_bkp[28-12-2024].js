...
const _consultationSchema = new mongoose.Schema([
    {
        ...
        visitTransaction: { type: mongoose.Schema.Types.ObjectId, ref: 'VisitTransactions' },
...
const _glassPrescriptionSchema = new mongoose.Schema({
    ...
    approvals: {
        phc: {
            ...
            rejectedDateTime: { type: Date },
            approvedDateTime: { type: Date },
            approvedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'Users' },
            requestReceivedDateTime: { type: Date },
            tat: { type: Number },
        },
        chc: {
            location: {
