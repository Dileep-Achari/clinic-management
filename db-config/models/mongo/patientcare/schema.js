                ...
                surgDtls: [
                    {
                        ...
                        mandFilledInRadioOutcomes: {
                            type: Boolean,
                            default: () => { return false; }
                        },
                        mandFilledInAdditDtls: {
                            type: Boolean,
                            default: () => { return false; }
                        },
                        mandFilledInPeriop: {
                        ...
                        intraRobotic: {
                            ...
                            crnlAlgn: String,
                            bfrBlncing: String,
                            bfrBlncingRmrks: String,
                            fnlAlignmnt: String,
                            axialAlgn: String,
                            ntvPcaTeaAng: String,
                            fnlFemRota: String,
                            fnlFemrRotaRemrks: String,
                            sagitalAlignm: String,
                            tibia: String,
                            crnlAlgnTbia: String,
                            fnlAlignmntTbia: String,
                            bfrBlncingRmrksTibia: String,
                            tibialSlpe: String,
                            ntvMedialSlp: String,
                            ntvLateralSlp: String,
                            bfrBlncingTbia: String,
                            sgitlAlgn: String
                        },
                        periOperPeriodObj: {
                            "_id": {
...
module.exports = [
    ...
    { "coll": 'unlockrequests', "schema": _unlockrequests, "db": "patient_care" },
    { "coll": 'mirtheventtrans', "schema": _mirth_event_trans, "db": "patient_care" },
    { "coll": 'templates', "schema": _templates, "db": "patient_care" },
    { "coll": 'alerts', "schema": _alerts, "db": "patient_care" },
    { "coll": 'reportrequests', "schema": _reportRequests, "db": "patient_care" },
    { "coll": 'reports', "schema": _reports, "db": "patient_care" },
    { "coll": 'pincodes', "schema": _pincodes, "db": "patient_care" },
];       