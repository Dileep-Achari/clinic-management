...
router.post("/auth-user", async (req, res) => {
    try {
        ...
        //         "password": _clnUser[0].password
        //     }
        // }
        // let _docData = await _mUtils.commonMonogoCall("cm_doctors", "find", _docParams, "", "", "", req.body.params.orgKey.toLowerCase());
        // if(_docData.success && _docData.data.length > 0){
        //     if(_docData.data[0].photo && _docData.data[0].photo !== "" && _docData.data[0].photoMimeType && _docData.data[0].photoMimeType.length > 0){
        //         let data = await getBase64Data(_docData.data[0].photoMimeType, _docData.data[0].photo)
        //         _user['photo'] = data
        //     }
        //     else{
        //         _user['photo'] = ""
        //     }
        //     if(_docData.data[0].signature && _docData.data[0].signature !== "" && _docData.data[0].signatureMimeType && _docData.data[0].signatureMimeType.length > 0){
        //         let data = await getBase64Data(_docData.data[0].signatureMimeType, _docData.data[0].signature)
        //         _user['signature'] = data
        //     }
        //     else{
        //         _user['signature'] = ""
        //     }
