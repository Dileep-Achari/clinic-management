        ...
        if (_data.length > _idx) {
            ...
            if (_data[_idx].depColl && _data[_idx].depColl.length == 0) {
                ...
                if (_data[_idx].type === "LABELS") {
                    ...
                    let _gcResp = await generateSeqCode(_data[_idx].data[0].labels, 0, [], "Labels", req);
                ...
                if (_roles[0].success && _roles[0].data.length > 0) {
                    _.each(_roles[0].data, (role) => {
                        let _user = {
                            ...
                            userName: `${result.data[0].orgKey.toLowerCase()}_${role.label.toLowerCase().replace(/\s+/g, "")}`,//result.data[0].locations[0].emailID,
                            password: `${result.data[0].orgKey.toLowerCase()}123`,
                            displayName: role.label,//`${result.data[0].orgKey} Admin`,
                            locations: [],
