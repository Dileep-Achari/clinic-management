    ...
    try {
        ...
        if (req.body.JSON[0].TYPE == "ALL" || req.body.JSON[0].TYPE == "") {
            if ((req.body.JSON[0].BRAND_PRODUCT_CD.length == 0) || (req.body.JSON[0].BRAND_PRODUCT_CD.length != 0)) {
                if (req.body.JSON[0].BRAND_PRODUCT_CD != "" && req.body.JSON[0].DRUG_CD == "" && req.body.JSON[0].CLS_CD == "" && req.body.JSON[0].FOOD_CD == "" && req.body.JSON[0].DIS_CD == "" && req.body.JSON[0].LAB_TEST_CD == "" && req.body.JSON[0].ALLERGY.length ==0) {
                ...
                } else if ((req.body.JSON[0].BRAND_PRODUCT_CD == "" && req.bodyJSON[0].DRUG_CD == "" && req.body.JSON[0].CLS_CD == "" && (req.bodyJSON[0].FOOD_CD != "" || req.body.JSON[0].DIS_CD != "" || req.body.JSON[0].LAB_TEST_CD != "" || req.body.JSON[0].ALLERGY.length >0))) {
                    let filterKeyData = []
                    ...
                    if (_BrandOrClassOrDrugCds.length > 0) {
                        ...
                        console.log("fhdfd",_finalGetInteractionDataWithAllScenearios.data)
...
router.post("/bulk-data", async (req, res) => {
    try {
        ...
        _.each(resonseData, async (o, i) => {
            ...
            _drugData.push({
                "BRAND_PRODUCT_MAP_CD": o.BRAND_PRODUCT_MAP_CD != null ? o.BRAND_PRODUCT_MAP_CD : "",
                "PARENT_BRAND_CD": o.PARENT_BRAND_CD != null ? o.PARENT_BRAND_CD : "",
                "PARENT_BRAND": o.PARENT_BRAND != null ? o.PARENT_BRAND : "",
                "BRAND_CD": o.BRAND_CD != null ? o.BRAND_CD : "",
                "BRAND_NAME": o.BRAND_NAME != null ? o.BRAND_NAME : "",
                "BRAND_EXTENSION_CD": o.BRAND_EXTENSION_CD != null ? o.BRAND_EXTENSION_CD : "",
                "BRAND_EXTENSION_NAME": o.BRAND_EXTENSION_NAME != null ? o.BRAND_EXTENSION_NAME : "",
                "THERAPY_CD": o.THERAPY_CD != null ? o.THERAPY_CD : "",
                "THERAPY_NAME": o.THERAPY_NAME != null ? o.THERAPY_NAME : "",
                "FLAVOUR_CD": o.FLAVOUR_CD != null ? o.FLAVOUR_CD : "",
                "STRENGTH_CD": o.STRENGTH_MASTER_CD != null ? o.STRENGTH_MASTER_CD : "",
                "STRENGTH_NAME": o.STRENGTH_NAME != null ? o.STRENGTH_NAME : "",
                "VOLUME_CD": o.VOLUME_CD != null ? o.VOLUME_CD : "",
                "VOLUME_NAME": o.VOLUME_NAME != null ? o.VOLUME_NAME : "",
                "PACKAGE_INFO_CD": o.PACKAGE_TYPE_CD != null ? o.PACKAGE_TYPE_CD : "",
                "PACKAGE_INFO": o.PACKAGE_TYPE_NAME != null ? o.PACKAGE_TYPE_NAME : "",
                "METRL_TYPE_CD": o.METRL_TYPE_CD != null ? o.METRL_TYPE_CD : "",
                "METRL_TYPE_NAME": o.METRL_TYPE_NAME != null ? o.METRL_TYPE_NAME : "",     
                "DOSE_FORM_CD": o.DOSE_FORM_CD != null ? o.DOSE_FORM_CD : "",
                "DOSE_FORM_NAME": o.DOSE_FORM_NAME != null ? o.DOSE_FORM_NAME : "",
                "USE_CD": o.USE_CD != null ? o.USE_CD : "",
                "USE_NAME": o.USE_NAME != null ? o.USE_NAME : "",   
                "STRG_CNDTN_CD": o.STRG_CNDTN_CD != null ? o.STRG_CNDTN_CD :""  ,   
                "STRG_CNDTN_NAME": o.STRG_CNDTN_NAME != null ? o.STRG_CNDTN_NAME : "",       
                "AGE_GEN_CD": o.AGE_GEN_CD != null ? o.AGE_GEN_CD : "",
                "AGE_GEN_NAME": o.AGE_GEN_NAME != null ? o.AGE_GEN_NAME : "",
                "COMPANY_CD": o.COMPANY_CD != null ? o.COMPANY_CD : "",   
                "COMPANY_NAME": o.COMPANY_NAME != null ? o.COMPANY_NAME :""  ,   
                "CDCI_CODE": o.CDCI_CODE != null ? o.CDCI_CODE : "",    
                "CDCI_NAME": o.CDCI_NAME != null ? o.CDCI_NAME : "",
                "BRAND_STRING1_CD": o.BRAND_STRING1_CD != null ? o.BRAND_STRING1_CD : "",   
                "BRAND_STRING1": o.BRAND_STRING1 != null ? o.BRAND_STRING1 :""  ,   
                "BRAND_STRING1_XML": o.BRAND_STRING1_XML != null ? o.BRAND_STRING1_XML : "",       
                "BRAND_STRING2_CD": o.BRAND_STRING2_CD != null ? o.BRAND_STRING2_CD : "",    
                "BRAND_STRING2": o.BRAND_STRING2 != null ? o.BRAND_STRING2 :""  ,   
                "BRAND_STRING2_XML": o.BRAND_STRING2_XML != null ? o.BRAND_STRING2_XML : "",  
                "BRAND_STRING3_CD": o.BRAND_STRING3_CD != null ? o.BRAND_STRING3_CD : "",   
                "BRAND_STRING3": o.BRAND_STRING3 != null ? o.BRAND_STRING3 :""  ,   
                "BRAND_STRING3_XML": o.BRAND_STRING3_XML != null ? o.BRAND_STRING3_XML : "",     
                "STRING_3": o.STRING_3 != null ? o.STRING_3 : "",
                "STRING_3_CD": o.STRING_3_CD != null ? o.STRING_3_CD : "",     
                "BRAND_CUSTOM": o.BRAND_CUSTOM != null ? o.BRAND_CUSTOM : "",
                "BRAND_CUSTOM_CD": o.BRAND_CUSTOM_CD != null ? o.BRAND_CUSTOM_CD : "",
                "BRAND_CUSTOM_XML": o.BRAND_CUSTOM_XML != null ? o.BRAND_CUSTOM_XML : "",
                "BRAND_FINAL_CD": o.BRAND_FINAL_CD != null ? o.BRAND_FINAL_CD : "",  
                "BRAND_FINAL": o.BRAND_FINAL != null ? o.BRAND_FINAL : "",     
                "BRAND_FINAL_XML": o.BRAND_FINAL_XML != null ? o.BRAND_FINAL_XML : "",
                "BRAND_DRUG_FINAL_CD": o.BRAND_DRUG_FINAL_CD != null ? o.BRAND_DRUG_FINAL_CD : "",
                "BRAND_DRUG_FINAL": o.BRAND_DRUG_FINAL != null ? o.BRAND_DRUG_FINAL : "",
                "BRAND_DRUG_XML": o.BRAND_DRUG_XML != null ? o.BRAND_DRUG_XML : "",  
                "IS_FORCEBLE_BRAND": o.IS_FORCEBLE_BRAND != null ? o.IS_FORCEBLE_BRAND : "",     
                "SOURCE_DATA": o.SOURCE_DATA != null ? o.SOURCE_DATA : "",
                "BRAND_DISPLAY_NAME": o.BRAND_DISPLAY_NAME != null ? o.BRAND_DISPLAY_NAME : "",
                "BRAND_MASTER_ID": o.BRAND_MASTER_ID != null ? o.BRAND_MASTER_ID : "",
                "REMARKS": o.REMARKS != null ? o.REMARKS : "",                                                                                                                  
                "audit": req.body.params.audit
            })
        })
        req.body.params = _drugData
        mongoMapper('monography_brand_product_mapping', "insertMany", req.body.params).then(async (result) => {
            return res.status(200).json({ success: true, status: 200, desc: '', data: result.data });
        }).catch((error) => {
            return res.status(400).json({ success: false, status: 400, desc: error.message || error, data: [] });
        });
    ...
    try {
        if (_data.length > _idx) {
            ...
            if (!(_mBrandProductResp && _mBrandProductResp.success)) {
                ...
                _filterObj.filter = {}
                _filterObj.filter['recStatus'] = { $eq: true }
                _filterObj.filter['STRING_3_CD'] =_mBrandProductResp.data.length >0&& _mBrandProductResp.data[0].STRING_3_CD ? _mBrandProductResp.data[0].STRING_3_CD:""
                ...
                if (!(_mClinicalProductResp && _mClinicalProductResp.success)) {
                    ...
                    _filterObj.filter['DD_DRUG_MASTER_CD'] =_mClinicalProductResp.data.length>0 && _mClinicalProductResp.data[0].DD_DRUG_MASTER_CD ? _mClinicalProductResp.data[0].DD_DRUG_MASTER_CD :""
...
async function commonGetData(_data, _idx, _output, req, _filterObj) {
    try {
        if (_data.length > _idx) {
            ...
            let _mResp = await _mUtils.commonMonogoCall("monography_drugchildinteraction", "find", _filter, "", "", "", "")
            console.log("dhfgdfh",_mResp.data)
            if (!(_mResp && _mResp.success)) {
                return res.status(400).json({ success: false, status: 400, desc: _mResp.desc || "", data: _mResp.data || [] });
            }
            if (_mResp.data.length > 0) {
        ...
        if (_data.length > _idx) {
            ...
            if (_data[_idx].BRAND_PRODUCT_CD || _data[_idx].CLS_CD || _data[_idx].DRUG_CD) {
                ...
                if ((_data[_idx].BRAND_PRODUCT_CD && _data[_idx].CLS_CD) || (_data[_idx].BRAND_PRODUCT_CD && _data[_idx].DRUG_CD)) {
                    ...
                    console.log("_BrandWithDifferentTypes",_BrandWithDifferentTypes.constructor.name)
                    if (_BrandWithDifferentTypes !=undefined && _BrandWithDifferentTypes.data&&_BrandWithDifferentTypes.data.length > 0) {
                        _.each(_BrandWithDifferentTypes.data, (_o, _i) => {
                            _output.push(_o)
                        })
                    }
                    ...
                    while (index < _data[_idx].ALLERGY.length){
                       if(_data[_idx].ALLERGY[index].TYPE =="Substance"){
