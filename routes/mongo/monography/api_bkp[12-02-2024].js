        ...
        if (_data.params.length > _idx) {
            ...
            if (!(_mResp && _mResp.success)) {
                ...
                if (_cBody.params.assignedTo[0].actionOfRole === "REVIEWER" || _cBody.params.assignedTo[0].actionOfRole === "EXTERNAL REVIEWER" || _cBody.params.assignedTo[0].actionOfRole === "CONTENT WRITER") {
                    ...
                    if (_cBody.params.assignedTo[0].actionOfRole === "PUBLISHER"){
                        delete _filter.filter.content_type
                        _dddrugdata = await _mUtils.commonMonogoCall("monography_dd_drug_master", "find", _filter, "", "", "", "")
            ...
            if (_method == "find") {
                ...
                if (req.body.params.SEARCH_TYPE != "ALL") {
                    ...
                    if (req.body.params.SEARCH_COL != "") {
                        ...
                        _filterObj.filter['INT_ID']= req.body.params.type ? req.body.params.type :delete _filterObj.filter.INT_ID 
            ...
            if (req.body.params.flag1 === "DRPDATA") {
                ...
                if (!(_mRespData && _mRespData.success)) {
                    ...
                    .map((_d,_k)=>{
                        if(_k !=""){
                            _totalUomData.push({
                               DISPlAY_NAME:_d[0].ALTERNATIVE_NAME.length> 0 ? _d[0].ALTERNATIVE_NAME :_d[0].UOM_ALL_NAME,
                               UOM_CD:_d[0].UOM_CD
                            })
                        }
                    })
...
router.post("/bulk-data", async (req, res) => {
    try {
        ...
        _.each(resonseData, async (o, i) => {
            //  let _seqResp = await _mUtils.getSequenceNextValue({ locId: req.tokenData.locId, seqName: 'unitsOfMeasurement' }, "monography", req);
            _drugData.push({
                "UOM_CD": o.UOM_CD != null ? o.UOM_CD : "",
                "UOM_L0_CODE": o.UOM_L0_CODE != null ? o.UOM_L0_CODE : "",
                "UOM_L0_NAME": o.UOM_L0_NAME != null ? o.UOM_L0_NAME : "",
                "UOM_L1_CODE": o.UOM_L1_CODE != null ? o.UOM_L1_CODE : "",
                "UOM_L1_NAME": o.UOM_L1_NAME != null ? o.UOM_L1_NAME : "",
                "UOM_L2_CODE": o.UOM_L2_CODE != null ? o.UOM_L2_CODE : "",
                "UOM_L2_NAME": o.UOM_L2_NAME != null ? o.UOM_L2_NAME : "",
                "UOM_L3_CODE": o.UOM_L3_CODE != null ? o.UOM_L3_CODE : "",
                "UOM_L3_NAME": o.UOM_L3_NAME != null ? o.UOM_L3_NAME : "",                    
                "UOM_L4_CODE": o.UOM_L4_CODE != null ? o.UOM_L4_CODE : "",
                "UOM_L4_NAME": o.UOM_L4_NAME != null ? o.UOM_L4_NAME : "",
                "UOM_L5_CODE": o.UOM_L5_CODE != null ? o.UOM_L5_CODE : "",
                "UOM_L5_NAME": o.UOM_L5_NAME != null ? o.UOM_L5_NAME : "",
                "UOM_ALL_CODE": o.UOM_ALL_CODE != null ? o.UOM_ALL_CODE : "",
                "UOM_ALL_NAME": o.UOM_ALL_NAME != null ? o.UOM_ALL_NAME : "",
                "DISPLAY_NAME": o.DISPLAY_NAME != null ? o.DISPLAY_NAME : "",
                "ALTERNATIVE_NAME": o.ALTERNATIVE_NAME != null ? o.ALTERNATIVE_NAME : "",
                "REMARKS": o.REMARKS != null ? o.REMARKS : "",                                                                                                                  
                "audit": req.body.params.audit
            })
        })
        req.body.params = _drugData
        mongoMapper('monography_uoms', "insertMany", req.body.params).then(async (result) => {
            return res.status(200).json({ success: true, status: 200, desc: '', data: result.data });
        }).catch((error) => {
            return res.status(400).json({ success: false, status: 400, desc: error.message || error, data: [] });
        });
