          ...
          //insert section data aganist content type(interaction) start.
            if(_getContentWriterData.length > 0 && _getContentWriterData[0].content_type == "650a9d0ad9a18e495d89d223"){
                ...
                if (!(_insSectionData && _insSectionData.success)) {
                  return res.status(400).json({ success: false, status: 400, desc: _insSectionData || "error", data:  [] });
              }
            }
...
//                         let _uResp = await _mUtils.commonMonogoCall("monography_users", "findById", _cBody.params.assignedTo[0].userId, "", "", "", "")
...
//     try {
//         if (_data.length > _idx) {
//             if (_data[_idx].SECTION_NAME != "References" && _data[_idx].SECTION_TYPE == "interaction") {
//                 _output.push(_data[_idx])
//             }
//             _idx = _idx + 1
...
//                             // _.each(monoGraphSectionData.data, (_mObj, _mIndx) => {
//                             //   let  _ok=[]
//                             //     _.each(_mObj.interacaction_drug_content, (_mIobj, _mIindx) => {
//                             //         _ok.push({
//                             //             _id: _mIobj._id,
//                             //             CREATE_BY: _mIobj.CREATE_BY ?  _mIobj.CREATE_BY :"",
//                             //             CREATE_DT: _mIobj.CREATE_DT ?  _mIobj.CREATE_DT :"",
//                             //             DRUG_IN_PARENT_ID: _mIobj.DRUG_IN_PARENT_ID ?  _mIobj.DRUG_IN_PARENT_ID :"",
//                             //             ENTITY_NAME: _mIobj.ENTITY_NAME ?  _mIobj.ENTITY_NAME :"",
//                             //             ENTITY_VALUE_NAME: _mIobj.ENTITY_VALUE_NAME,
//                             //             INT_ID: _mIobj.INT_ID,
//                             //             INT_TYPE_ID: _mIobj.INT_TYPE_ID,
//                             //             INTERACTIONS: _mIobj.INTERACTIONS,
//                             //             LOC_ID: _mIobj.LOC_ID ?_mIobj.LOC_ID :"",
//                             //             INTERACTIONS: _mIobj.INTERACTIONS,
//                             //             ORG_ID: _mIobj.ORG_ID ? _mIobj.ORG_ID :"",
//                             //             ROA_NAME: _mIobj.ROA_NAME,
//                             //             SEVERITY_ID: _mIobj.SEVERITY_ID,
//                             //             SEVERITY_NAME: _mIobj.SEVERITY_NAME,
//                             //             SRC_DRUG_CD: _mIobj.SRC_DRUG_CD,
//                             //         })
//                             //     })
//                             //   delete  _mObj.interacaction_drug_content 
//                             //     _mObj['interacaction_drug_content']=_ok
//                             //     console.log("_mObj",_mObj)
//                             // })
//                         }
//                         // let groupdata=[]
//                         // let _differentData=[]
...
//                         //     }
//                         //   });
//                         //  console.log("_differentData",_differentData)
...
//                         if (monoGraphSectionData.data.length > 0) {
//                             _.each(_sResp.data, (_statusObjects, _statusIndx) => {
//                                 _.each(monoGraphSectionData.data, (_monoObjects, _monoStatus) => {
//                                     if (_statusObjects.SECTION_NAME == _monoObjects.SECTION_NAME) {
//                                         let _arrey = _monoObjects.interacaction_drug_content
//                                         console.log("_arrey", _arrey)
...
//                                             }
//                                             _arrey.push(_sjgd)
//                                                 - console.log("_monoObjects.interacaction_drug_content", _arrey)
//                                         })
//                                     }
//                                 })
//                             })
//                             let _uSections = await updateSectionData(monoGraphSectionData.data, 0, [], req, "", "", "monography_sections", "bulkWrite", "BW")
//                             if (!(_uSections && _uSections.success)) {
//                                 return res.status(400).json({ success: false, status: 400, desc: _resp.desc || "", data: [] })
//                             }
//                         } else {
...
router.post("/insert-master-data",async(req,res) =>{
    try {
       let _seqResp;
       if(req.body.params.flag != "INN" && req.body.params.flag != "UNII" && req.body.params.flag != "SNOWMED"  ){
       ...
       if(req.body.params.flag == "UOM"){
           ...
           let _filter = {
               "filter": {
                   "ATC_LEVEL_NAME": req.body.params.ATC_LEVEL_NAME
               }
           }
...
router.post("/update-master-data",async(req,res)=>{
   try {
       ...
       if (req.body.params._id) {
           ...
           let pLoadResp = { payload: {} };
           let _mResp = await _mUtils.commonMonogoCall(`monography_${_collectionName}`, "findById", req.body.params._id, "REVNO", req.body, "", req.tokenData.orgKey)
           if (!(_mResp && _mResp.success)) {
               return res.status(400).json({ success: false, status: 400, desc: _mResp.desc || "", data: _mResp.data || [] });
           }
