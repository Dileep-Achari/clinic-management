...
router.post("/validate-user", async (req, res) => {
    try {
        if (req.body.params && req.body.params.userName && req.body.params.userName.length > 0) {
            ...
            mongoMapper("patient_care_users", "find", _filter,_dbType).then((result) => {
...
router.post("/get-all-patient-data", async (req, res) => {
    try {
        ...
        mongoMapper("patient_care_patients", "find", _filter,req.tokenData.dbType).then((result) => {
...
router.post("/insert-patient", async (req, res) => {
    try {
        ...
        mongoMapper('patient_care_patients', req.body.query, req.body.params,req.tokenData.dbType).then((result) => {
            return res.status(200).json({ status: 'SUCCESS', desc: '', data: result.data });
        }).catch((error) => {
            return res.status(400).json({ status: 'FAIL', desc: error.desc || error, data: [] });
        });
...
router.post("/update-patient-details", async (req, res) => {
    try {
        ...
        mongoMapper('patient_care_patients', 'bulkWrite', pLoadResp.payload,req.tokenData.dbType).then((result) => {
            return res.status(200).json({ status: 'SUCCESS', desc: '', data: result.data });
        }).catch((error) => {
            return res.status(400).json({ status: 'FAIL', desc: error.desc || error, data: [] });
        });
...
router.post("/get-surgery-data-by-id", async (req, res) => {
    try {
        if (req.body.params.admNo && req.body.params.surgId) {
            ...
            mongoMapper("patient_care_surgeries", "findOne", _params,req.tokenData.dbType).then((result) => {
...
router.post("/get-scores-data-by-id", async (req, res) => {
    try {
        if (req.body.params._id) {
            mongoMapper("patient_care_scores", "findById", req.body.params._id,req.tokenData.dbType).then((result) => {
                if (!(result.data && result.data._id)) {
                    return res.status(400).json({ status: 'FAIL', desc: "No Records are available.." || error, data: [] });
                }
                return res.status(200).json({ status: 'SUCCESS', desc: '', data: result.data || [] });
...
router.post("/insert-role", async (req, res) => {
    try {
        ...
        delete req.body.params.audit;
        mongoMapper('patient_care_roles', req.body.query, req.body.params,req.tokenData.dbType).then((result) => {
...
router.post("/get-user", async (req, res) => {
    try {
        ...
        mongoMapper("patient_care_users", "find", _pGData.data,req.tokenData.dbType).then((result) => {
            return res.status(200).json({ success: true, status: 200, desc: '', data: result.data });
        }).catch((error) => {
            return res.status(400).json({ success: false, status: 400, desc: error.desc || error, data: [] });
        });
...
router.post("/insert-form", async (req, res) => {
    try {
        ...
        req.body.params["cd"] = _seqResp.data;
        mongoMapper('patient_care_forms', req.body.query, req.body.params,req.tokenData.dbType).then((result) => {
            return res.status(200).json({ success: true, status: 200, desc: '', data: result.data });
        }).catch((error) => {
            return res.status(400).json({ success: false, status: 400, desc: error.desc || error, data: [] });
        });
...
router.post("/get-forms", async (req, res) => {
    try {
        ...
        mongoMapper("patient_care_forms", "find", _pGData.data,req.tokenData.dbType).then((result) => {
            return res.status(200).json({ success: true, status: 200, desc: '', data: result.data });
        }).catch((error) => {
            return res.status(400).json({ success: false, status: 400, desc: error.desc || error, data: [] });
        });
...
router.post("/insert-counter", async (req, res) => {
    try {
        ...
        mongoMapper('patient_care_counters', req.body.query, req.body.params,req.tokenData.dbType).then((result) => {
            return res.status(200).json({ success: true, status: 200, desc: '', data: result.data });
        }).catch((error) => {
            return res.status(400).json({ success: false, status: 400, desc: error.desc || error, data: [] });
        });
...
router.post("/insert-field-management", async (req, res) => {
    try {
        if (req.body && req.body.params) {
            ...
            mongoMapper('patient_care_fieldsmanagement', req.body.query, req.body.params,req.tokenData.dbType).then((result) => {
                return res.status(200).json({ success: true, status: 200, desc: '', data: result.data });
            }).catch((error) => {
                return res.status(400).json({ success: false, status: 400, desc: error.desc || error, data: [] });
            });
...
router.post("/get-field-management", async (req, res) => {
    try {
        if (req.body && req.body.params) {
            ...
            mongoMapper("patient_care_fieldsmanagement", "find", _pGData.data,req.tokenData.dbType).then((result) => {
...
router.post("/logout", async (req, res) => {
    try {
        ...
        mongoMapper("patient_care_usersessions", "findOneAndUpdate", pLoadResp.payload,req.tokenData.dbType).then((result) => {
...
router.post("/get-all-surgeries-list", async (req, res) => {
    try {
        ...
        mongoMapper("patient_care_surgeries", "aggregation", _filter,req.tokenData.dbType).then((result) => {
