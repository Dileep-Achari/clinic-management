...
let _users = [
    ...
    },
    {
        ...
        "users": [
            ...
            { "userId": 1238, "userName": "emradmin3", "pwd": "softhealth", "displayName": "EMR Admin", "roleId": 1, "roleName": "admin" }
        ]
    },
    {
        "orgId": 2, "locId": 31,
...
/**Auth User */
router.post("/auth-user-v1", async (req, res) => {
    try {
        if (req.body && req.body.orgId && req.body.uName && req.body.pwd) {
            ...
            // }
            let _user = {
                "orgId": _clnUser.orgId, "locId": _clnUser.locId, "userId": _clnUser._id, "userName": _clnUser.userName,
                "displayName": _clnUser.dispName, "roleId": _clnUser.roleId, "roleName": _clnUser.roleName
            };
            ...
            let _sessionParams = {
                ...
                locId: _clnUser.locId,
                userId: _clnUser._id,
                userName: _clnUser.userName,
                displayName: _clnUser.dispName,
                roleId: _clnUser.roleId,
                roleName: _clnUser.roleName,
                browser: _userAgent,
                token: _tkn,
    ...
    try {
        if (req.body && req.body.orgId && req.body.uName && req.body.pwd) {
            ...
            if (req.body.forceLogout && req.body.sessionId) {
                ...
                _tknObj.params["audit.modifiedBy"] = _userDtls[0].displayName;
                _tknObj.params["audit.modifiedById"] = _userDtls[0].userId;
                _tknObj.params["audit.modifiedDt"] = new Date().toISOString();
                let pLoadResp = { payload: {} };
                pLoadResp = await preparePayload('U', _tknObj);
                let _sessionUpdate = await commonMonogoCall("patient_care_usersessions", "findOneAndUpdate", pLoadResp.payload, "", "");
            ...
            let _user = {
                "orgId": 1002 || _orgDtls[0].orgId, "locId": 1047 || _orgDtls[0].locId, "createdDt": new Date(), "userId": _userDtls[0].userId, "userName": _userDtls[0].userName,
                "displayName": _userDtls[0].displayName, "roleId": _userDtls[0].roleId, "roleName": _userDtls[0].roleName
            };
            let _tkn = await generateToken(_user);
            res.cookie('x-token', _tkn, { maxAge: 9000000, httpOnly: true });
            _user['x-token'] = _tkn;
            ...
            let _sessionParams = {
                orgId: 1002 || _orgDtls[0].orgId,
                locId: 1047 || _orgDtls[0].locId,
                userId: _userDtls[0].userId,
                userName: _userDtls[0].userName,
                displayName: _userDtls[0].displayName,
                roleId: _userDtls[0].roleId,
                roleName: _userDtls[0].roleName,
                browser: _userAgent,
                token: _tkn,
                machine: req.isMobile ? 'Mobile' : 'Web'
            };
                        ...
                        params: {
                            ...
                            surgeries:
                                [{
                                    ...
                                    surgeryClosedDt: _cloneBody.admns[0].surgDtls[0].surgeryClosedDt,
