...
router.post('/getMobCountsMob', (req, res) => {
    mapper(dbSchema.getMobCountsMob, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprInsupdIpHandoffCommunicationRadiology', (req, res) => {
    mapper(dbSchema.uprInsupdIpHandoffCommunicationRadiology, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprGetHandoffCommunicationRadiology', (req, res) => {
    mapper(dbSchema.uprGetHandoffCommunicationRadiology, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprInsupdIpSurgeonAssessmentMob', (req, res) => {
    mapper(dbSchema.uprInsupdIpSurgeonAssessmentMob, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
});
router.post('/uprInsupdIpSurgeonsOperationNotesMob', (req, res) => {
    mapper(dbSchema.uprInsupdIpSurgeonsOperationNotesMob, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprInsupdPostOperativeSurgeonOrdersMob', (req, res) => {
    mapper(dbSchema.uprInsupdPostOperativeSurgeonOrdersMob, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprInsupdIpHandoffCommunicationRadiologyMob', (req, res) => {
    mapper(dbSchema.uprInsupdIpHandoffCommunicationRadiologyMob, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
});
router.post('/uprInsupdScoresAssesssmentMob', (req, res) => {
    mapper(dbSchema.uprInsupdScoresAssesssmentMob, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprInsupdAllScoresDataJsonMob', (req, res) => {
    mapper(dbSchema.uprInsupdAllScoresDataJsonMob, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprInsupdIpTurningChartMob', (req, res) => {
    mapper(dbSchema.uprInsupdIpTurningChartMob, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprInsupdIpIntakeOutputChartMob', (req, res) => {
    mapper(dbSchema.uprInsupdIpIntakeOutputChartMob, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprGetIpTurningChart', (req, res) => {
    mapper(dbSchema.uprGetIpTurningChart, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprGetIpIntakeOutputChart', (req, res) => {
    mapper(dbSchema.uprGetIpIntakeOutputChart, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprInsupdIpPatInsulinMob', (req, res) => {
    mapper(dbSchema.uprInsupdIpPatInsulinMob, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprInsupdDocProgressNotesMob', (req, res) => {
    mapper(dbSchema.uprInsupdDocProgressNotesMob, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprGetDocProgressNotes', (req, res) => {
    mapper(dbSchema.uprGetDocProgressNotes, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprInsupIpAldreateScore', (req, res) => {
    mapper(dbSchema.uprInsupIpAldreateScore, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprInsupdNurseOrder', (req, res) => {
    req.body.NURSE_ORDER_JSON = JSON.stringify(req.body.NURSE_ORDER_JSON)
...
router.post('/insUpdMedAdministrationJson', (req, res) => {
    req.body.MEDICATION_ADMINISTRED_JSON = JSON.stringify(req.body.MEDICATION_ADMINISTRED_JSON)
...
router.post('/uprGetNurseStationMob', (req, res) => {
    mapper(dbSchema.uprGetNurseStationMob, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprGetTransferDetailsMob', (req, res) => {
    mapper(dbSchema.uprGetTransferDetailsMob, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprGetIpStockPoints', (req, res) => {
    mapper(dbSchema.uprGetIpStockPoints, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprPhrInsupdConditionMob', (req, res) => {
    mapper(dbSchema.uprPhrInsupdConditionMob, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        console.log("error",error)
        res.status(400).send(error);
...
router.post('/getOpClinicalData_v1', (req, res) => {
...
router.post('/uprGetPatDialysisGrid', (req, res) => {
    mapper(dbSchema.uprGetPatDialysisGrid, req.body, req.cParams).then((response) => {
        return res.status(200).json(response);
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprInsupdEolCareAssessmentJson', (req, res) => {
    req.body.EOL_CARE_ASSESSMENT_JSON=JSON.stringify(req.body.EOL_CARE_ASSESSMENT_JSON);
