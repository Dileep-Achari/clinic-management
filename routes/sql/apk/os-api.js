...
router.all('/*', (req, res, next) => {
    try {
		...
		if(req.cParams.URL  ==='bookAppointment')
		    req.cParams.IS_MULTI_RESULTSET ='Y';
		console.log("os-api-cofig",req.cParams);
...
/** To  Consultations Reschedule
 * 
**/
router.post('/rescheduleAppointment', (req, res) => {
    mapper(dbSchema.rescheduleAppointment, req.body, req.cParams).then((response) => {
        res.json(responseChange(response, req.cParams));
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/cancelAppointment', (req, res) => {
    mapper(dbSchema.cancelAppointment, req.body, req.cParams).then((response) => {
        res.json(responseChange(response, req.cParams));
    }).catch((error) => {
        res.status(400).send(error);
    });
...
/**
 * to get doctor holidays
 */

router.post('/getDoctorHolidays', (req, res) => {
    //console.log("req.body",req.body)
    mapper(dbSchema.getDoctorHolidays, req.body, req.cParams).then((response) => {
 ...
 * summary base64 Data
 */
router.post('/getDissumReportAsBase64', (req, res) => {
    // console.log("req.body",req.body)
    mapper(dbSchema.getDissumReportAsBase64, req.body, req.cParams).then((response) => {
       // console.log("response",response)
        res.json(responseChange(response, req.cParams));
    }).catch((error) => {
        res.status(400).send(error);
...
router.post('/getAdmissionByUMR', (req, res) => {
    mapper(dbSchema.getAdmissionByUMR, req.body, req.cParams).then((response) => {
        res.json(responseChange(response, req.cParams));
    }).catch((error) => {
        res.status(400).send(error);
    });
 ...
 * 
**/
router.post('/getReportAsBase64', (req, res) => {
    mapper(dbSchema.getReportAsBase64, req.body, req.cParams).then((response) => {
        res.json(responseChange(response, req.cParams));
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/getAllDoctor', (req, res) => {
    mapper(dbSchema.getAllDoctor, req.body, req.cParams).then((response) => {
        res.json(responseChange(response, req.cParams));
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprInsupdHisLog', (req, res) => {
    mapper(dbSchema.uprInsupdHisLog, req.body, req.cParams).then((response) => {
        res.json(responseChange(response, req.cParams));
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprGetHisLog', (req, res) => {
    mapper(dbSchema.uprGetHisLog, req.body, req.cParams).then((response) => {
        res.json(responseChange(response, req.cParams));
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/getMedicationsBySlotId', (req, res) => {
    mapper(dbSchema.getMedicationsBySlotId, req.body, req.cParams).then((response) => {
        res.json(responseChange(response, req.cParams));
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/getPatientDataCems', (req, res) => {
    mapper(dbSchema.getPatientDataCems, req.body, req.cParams).then((response) => {
        res.json(responseChange(response, req.cParams));
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprInsupdCemsSmsLog', (req, res) => {
    mapper(dbSchema.uprInsupdCemsSmsLog, req.body, req.cParams).then((response) => {
        res.json(responseChange(response, req.cParams));
    }).catch((error) => {
        res.status(400).send(error);
    });
...
router.post('/uprGetCemsSmsLog', (req, res) => {
    mapper(dbSchema.uprGetCemsSmsLog, req.body, req.cParams).then((response) => {
        res.json(responseChange(response, req.cParams));
    }).catch((error) => {
        res.status(400).send(error);
    });
